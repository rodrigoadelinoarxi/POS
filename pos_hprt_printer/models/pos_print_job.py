    ...
    def action_send(self):
        ...
        for job in self:
            if job.job_type == 'kitchen':
                # A mesa é apenas informativa. O ticket é enviado de imediato;
                # quando existir mesa ela segue no payload, caso contrário o
                # ticket imprime normalmente sem esse campo.
